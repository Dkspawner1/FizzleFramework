...
namespace fizzle {
	...
	{
		SDL_GPUCommandBuffer* command_buffer = SDL_AcquireGPUCommandBuffer(m_graphics_device.GetDevice());
		if (!command_buffer)
		{
		...
		SDL_WaitAndAcquireGPUSwapchainTexture(
			command_buffer, m_window, &swapchain, &g_WINDOW_WIDTH, &g_WINDOW_HEIGHT
		);
